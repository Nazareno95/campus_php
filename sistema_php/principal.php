    ...
    <header class="navbar navbar-inverse" role="banner">
        <div class="navbar-header">            
            <a class="navbar-brand" href="principal.php">
                <!--<img src="css/images/PB.png" alt="logo" />-->NAZARENO MEDRANO
            </a>
        </div>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="#">Mostrar listado</a></li>                    
                </ul>
            </li> 
        </ul>
    </div>
        ...
        <div id="pad-wrapper" class="form-page">
            <div class="row header">
                ...
                <img src="css/images/www.png">
                            ...
                            <h1 align="center">Campo virtual desarrollado por Nazareno Medrano</h1>
